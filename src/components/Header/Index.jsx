          ...
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <li className="nav-item dropdown" style={{ marginTop: 0 }}>
                ...
                role="button" aria-haspopup="true" aria-expanded="false">
                  <img src='assets/flags/usa.png' className='flag'/>
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <a href="#" onClick={() => handleLanguageChange('pl')}>
                      <img src='assets/flags/pl.png' className='flag'/>
                      Polish
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={() => handleLanguageChange('de')}>
                      <img src='assets/flags/de.png' className='flag'/>
                      Deutsch
                    </a>
                  </li>
                  <li>
                    <a href="#" onClick={() => handleLanguageChange('br')}>
                      <img src='assets/flags/br.png' className='flag'/>
                      Portuguese
                    </a>  
                  </li>
                  <li>
                    <a href="#" onClick={() => handleLanguageChange('es')}>
                      <img src='assets/flags/es.png' className='flag'/>
                      Spanish
                    </a>
                  </li>
                </ul>
